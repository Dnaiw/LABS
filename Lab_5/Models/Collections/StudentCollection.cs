...
using Lab_5.Delegates;
using Lab_5.Models.Events;
using Action = Lab_5.Models.Events.Action;

namespace Lab_5.Models.Collections
{
    ...
    internal class StudentCollection<TKey>
    {
        ...
        private void Add(Student student)
        {
            ...
            this.students.Add(key, student);
            this.StudentsChanged?.Invoke(this, new StudentsChangedEventArgs<TKey>(this.Name, Action.Add, nameof(student), key));
